        ...
        <div class="flex items-center justify-center min-h-screen px-4 pt-4 pb-20">
            ...
            <div class="relative inline-block bg-white dark:bg-gray-800 rounded-2xl text-left overflow-hidden shadow-xl transform transition-all w-full max-w-4xl">
                        ...
                        <div class="flex items-start space-x-6 pb-6 border-b border-gray-200 dark:border-gray-700">
                            ...
                            <div class="flex-1">
                                ...
                                <div class="flex items-center space-x-2">
                                    ...
                                    @elseif($selectedUser->type == 'admin')
                            ...
                            <div class="space-y-6">
                                ...
                                <div>
                                    ...
                                    <div class="bg-gray-50 dark:bg-gray-900 rounded-xl p-4 space-y-3">
                                        <!-- Email -->
                                        <div>
                                            <p class="text-xs text-gray-500 dark:text-gray-400 uppercase mb-1">Email Address</p>
                                            <p class="text-sm font-medium text-gray-900 dark:text-white flex items-center">
                                                ...
                                                @else
                                                    <span class="ml-2 text-xs text-red-600 dark:text-red-400">(Not Verified)</span>
                                                @endif
                                            </p>
                                        </div>

                                        <!-- Mobile Number -->
                                        @if($selectedUser->mobile_number)
                                            <div>
                                                <p class="text-xs text-gray-500 dark:text-gray-400 uppercase mb-1">Mobile Number</p>
                                                <p class="text-sm font-medium text-gray-900 dark:text-white">{{ $selectedUser->mobile_number }}</p>
                                            </div>
                                        @endif
                                    </div>
                                </div>
                                    ...
                                    <div class="bg-gray-50 dark:bg-gray-900 rounded-xl p-4 space-y-3">
                                        ...
                                        @if($selectedUser->address)
                                            <div>
                                                ...
                                                <p class="text-sm font-medium text-gray-900 dark:text-white">{{ $selectedUser->address }}</p>
                                            </div>
                                        @endif
                                        ...
                                        @if($selectedUser->city)
                                            <div>
                                                ...
                                                <p class="text-sm font-medium text-gray-900 dark:text-white">{{ $selectedUser->city->name }}</p>
                                            </div>
                                        @endif
                                        ...
                                        @if($selectedUser->state)
                                            <div>
                                                ...
                                                <p class="text-sm font-medium text-gray-900 dark:text-white">{{ $selectedUser->state->name }}</p>
                                            </div>
                                        @endif
                                        ...
                                        @if($selectedUser->country)
                                            <div>
                                                ...
                                                <p class="text-sm font-medium text-gray-900 dark:text-white flex items-center">
                                                    <span class="mr-2">{{ $selectedUser->country->emoji }}</span>
                                        ...
                                        @if($selectedUser->address || $selectedUser->city || $selectedUser->state || $selectedUser->country)
                                            <div class="pt-3 border-t border-gray-200 dark:border-gray-700">
                                                <p class="text-xs text-gray-500 dark:text-gray-400 uppercase mb-1">Full Address</p>
                            ...
                            <div class="space-y-6">
                                ...
                                <div>
                                    ...
                                    <div class="bg-gray-50 dark:bg-gray-900 rounded-xl p-4 space-y-3">
                                        <!-- Status -->
                                        <div>
                                            <p class="text-xs text-gray-500 dark:text-gray-400 uppercase mb-1">Account Status</p>
                                            <div class="flex items-center space-x-2">
                                                @if($selectedUser->status == 1)
                                                    <span class="flex items-center text-sm font-semibold text-green-600 dark:text-green-400">
                                        ...
                                        <!-- User Type -->
                                        <div>
                                            <p class="text-xs text-gray-500 dark:text-gray-400 uppercase mb-1">User Type</p>
                                            <p class="text-sm font-medium text-gray-900 dark:text-white capitalize">{{ $selectedUser->type }}</p>
                                        </div>

                                        <!-- Gender -->
                                        <div>
                                            <p class="text-xs text-gray-500 dark:text-gray-400 uppercase mb-1">Gender</p>
                                            <p class="text-sm font-medium text-gray-900 dark:text-white">
                                                {{ $selectedUser->gender == 1 ? 'Female' : 'Male' }}
                                            </p>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div>
                                    ...
                                    <div class="bg-gray-50 dark:bg-gray-900 rounded-xl p-4 space-y-3">
                                        ...
                                        <div>
                                            ...
                                            <p class="text-sm font-mono font-medium text-gray-900 dark:text-white">#{{ str_pad($selectedUser->id, 6, '0', STR_PAD_LEFT) }}</p>
                                        </div>
                                        ...
                                        <div>
                                            ...
                                            <p class="text-sm font-medium text-gray-900 dark:text-white">
                                                {{ $selectedUser->created_at->format('F d, Y') }}
                                                <span class="text-xs text-gray-500">({{ $selectedUser->created_at->diffForHumans() }})</span>
                                            </p>
                                        </div>

                                        <!-- Last Updated -->
                                        <div>
                                            <p class="text-xs text-gray-500 dark:text-gray-400 uppercase mb-1">Last Updated</p>
                                            <p class="text-sm font-medium text-gray-900 dark:text-white">
                                                {{ $selectedUser->updated_at->format('F d, Y H:i') }}
                                            </p>
                                        </div>
                                        ...
                                        @if($selectedUser->email_verified_at)
                                            <div>
                                                <p class="text-xs text-gray-500 dark:text-gray-400 uppercase mb-1">Email Verified</p>
                                                <p class="text-sm font-medium text-green-600 dark:text-green-400">
                                                    {{ $selectedUser->email_verified_at->format('F d, Y') }}
                                                </p>
                                            </div>
                                        @endif
                                    </div>
                ...
                <div class="px-6 py-4 bg-gray-50 dark:bg-gray-900 border-t border-gray-200 dark:border-gray-700 flex justify-between items-center">
                    ...
                    <button 
                        wire:click="editUser({{ $selectedUser->id }})"
