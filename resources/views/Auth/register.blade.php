...
<head>
    ...
    <title>Register - Cartify Pro</title>
    <!-- Font Awesome -->
    ...
    <div class="min-h-screen flex items-center justify-center px-4 py-12">
        <div class="max-w-5xl w-full">
            ...
            <div class="text-center mb-8">
                ...
                <h2 class="mt-6 text-3xl font-bold text-gray-900 dark:text-white">Create Account</h2>
                <p class="mt-2 text-sm text-gray-600 dark:text-gray-400">Join us today and start shopping!</p>
            </div>
            ...
            <div class="bg-white dark:bg-gray-800 rounded-2xl shadow-xl p-8 border border-gray-100 dark:border-gray-700">
                ...
                <form method="POST" action="{{ route('post-register') }}" enctype="multipart/form-data" class="space-y-6">
                    ...
                    <div class="space-y-4">
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-5 gap-4">
                            ...
                            <div>
                                ...
                                <div class="flex space-x-4 pt-2">
                                    <label class="flex items-center">
                                        <input type="radio" name="gender" value="0" {{ old('gender') == '0' ? 'checked' : '' }}  class="w-5 h-5 text-blue-600 border-gray-300 dark:border-gray-600 focus:ring-blue-500 dark:bg-gray-700">
                                        <span class="ml-2 text-sm text-gray-700 dark:text-gray-300">
                                            <i class="fas fa-mars text-blue-600 dark:text-blue-400 mr-1"></i>Male
                                        </span>
                                    </label>
                                    <label class="flex items-center">
                                        <input type="radio" name="gender" value="1" {{ old('gender') == '1' ? 'checked' : '' }}  class="w-5 h-5 text-pink-600 border-gray-300 dark:border-gray-600 focus:ring-pink-500 dark:bg-gray-700">
                                        <span class="ml-2 text-sm text-gray-700 dark:text-gray-300">
                                            <i class="fas fa-venus text-pink-600 dark:text-pink-400 mr-1"></i>Female
                                        </span>
                                    </label>
                                </div>
                                 @error('gender')
                            ...
                            <div class="md:col-span-2">
                                <label class="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-2">
                                    <i class="fas fa-camera text-gray-400 dark:text-gray-500 mr-2"></i>Profile Picture <span class="text-red-500 dark:text-red-400">*</span>
                                </label>
                                <div class="flex items-center space-x-4">
                                    <div class="w-20 h-20 rounded-full bg-gray-100 dark:bg-gray-700 flex items-center justify-center overflow-hidden" id="imagePreview">
                                        <i class="fas fa-user text-gray-400 dark:text-gray-500 text-2xl"></i>
                                    </div>
                                    <label class="cursor-pointer">
                                        <span class="px-4 py-2 bg-gray-100 dark:bg-gray-700 text-gray-700 dark:text-gray-300 rounded-lg hover:bg-gray-200 dark:hover:bg-gray-600 inline-flex items-center">
                    ...
                    <div class="space-y-4">
                        <h3 class="text-lg font-semibold text-gray-900 dark:text-white flex items-center">
                            <i class="fas fa-address-card text-blue-600 dark:text-blue-400 mr-2"></i>
                            Contact & Address
                        </h3>
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-4 gap-4">
                            ...
                            <!-- State -->
                            <div>
                                <label for="state_id" class="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-2">
                                    State/Province
                                </label>
                                <select 
                                    id="state_id" 
                    ...
                    <div class="flex items-start">
                        <input 
                            ...
                            name="remember_me" 
                            id="remember_me"
                            class="w-4 h-4 mt-1 text-blue-600 border-gray-300 dark:border-gray-600 rounded focus:ring-blue-500 dark:bg-gray-700"
                        >
                        <label class="ml-3 text-sm text-gray-600 dark:text-gray-400" for="remember_me">
                            Remeber me
                        </label>
                    </div>
                ...
                <div class="mt-6 text-center">
                    <p class="text-sm text-gray-600 dark:text-gray-400">
                        ...
                        <a href="{{ route('login') }}" class="font-semibold text-blue-600 dark:text-blue-400 hover:text-blue-700 dark:hover:text-blue-300">
                            Sign in
                        </a>
                    </p>
                </div>
